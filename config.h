...
static const char *fonts[]          = { "FontAwesome:size:11;Ubuntu:size=11" };
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-bw", "3" , "-l", "20", "-g", "5", "-c" ,NULL};
